  ...
  return (
    ...
    >
      <div ref={contentRef} className="max-w-5xl mx-auto text-center">
        <h2 className="text-5xl md:text-6xl font-bold mb-8">Interfaces</h2>
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Elegant and intuitive touch interfaces designed for seamless control of your smart home devices.
        </p>
        <div className="bg-white/5 border border-white/10 rounded-lg p-12 hover:border-blue-500/50 transition">
          <img 
            src="/assets/interfaces.jpg" 
            alt="Interfaces" 
